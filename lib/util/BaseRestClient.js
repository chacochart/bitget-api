    ...
    signRequest(data, endpoint, method, signMethod) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (signMethod === 'bitget') {
                ...
                res.sign = yield (0, browser_support_1.signMessage)(paramsStr, this.apiSecret, 'base64');
                res.queryParamsWithSign = signRequestParams;
                return res;
            }
            console.error(new Date(), (0, websocket_util_1.neverGuard)(signMethod, `Unhandled sign method: "${browser_support_1.signMessage}"`));
            return res;
        });
    }
