...
const browser_support_1 = require("./browser-support");
...
function getWsAuthSignature(apiKey_1, apiSecret_1, apiPass_1) {
    return __awaiter(this, arguments, void 0, function* (apiKey, apiSecret, apiPass, recvWindow = 0) {
        ...
        const signature = yield (0, browser_support_1.signMessage)(signatureExpiresAt + 'GET' + '/user/verify', apiSecret, 'base64');
        return {
